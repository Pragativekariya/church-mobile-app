                ...
                children: <Widget>[
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          Icon(Icons.group, size: 20.0, color: Colors.black),
                          Container(width: 10),
                          SizedBox(
                            width: 180,
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          Icon(Icons.edit, size: 20.0, color: Colors.black),
                          Container(width: 10),
                          SizedBox(
                            width: 180,
                            child: Text(t.updateprofile,
                                overflow: TextOverflow.ellipsis,
                                softWrap: true,
                                style: TextStyles.subhead(context).copyWith(
                                  fontSize: 15,
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          Icon(Icons.note, size: 20.0, color: Colors.black),
                          Container(width: 10),
                          SizedBox(
                            width: 180,
                            child: Text(t.notes,
